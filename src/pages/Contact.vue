<template>
  ...
  >
    <div class="flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
      ...
      <div class="grid w-full grid-cols-1 gap-2 xs:grid-cols-2 sm:w-auto sm:flex sm:flex-wrap">
        <a
          href="mailto:swampyae330@gmail.com"
          class="group inline-flex items-center justify-center gap-2 rounded-lg border border-gray-200 bg-white px-4 py-2.5 text-sm font-medium text-gray-700 transition hover:bg-gray-50 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-200 dark:hover:bg-slate-700"
        >
        ...
        <a
          ...
          class="group inline-flex items-center justify-center gap-2 rounded-lg border border-gray-200 bg-white px-4 py-2.5 text-sm font-medium text-gray-700 transition hover:bg-gray-50 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-200 dark:hover:bg-slate-700"
        >
          <svg class="h-4 w-4 shrink-0 text-gray-700 dark:text-slate-300" fill="currentColor" viewBox="0 0 24 24">
