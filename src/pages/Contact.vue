<template>
  <section
    id="contact"
    class="mt-16 rounded-xl border border-primary-100 bg-primary-50 p-6 sm:p-8 dark:border-primary-500/15 dark:bg-primary-500/5"
  >
    <div class="flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
      ...
      <div class="flex flex-wrap gap-2">
        <a
          ...
          class="group inline-flex items-center gap-2 rounded-lg border border-gray-200 bg-white px-4 py-2.5 text-sm font-medium text-gray-700 transition hover:bg-gray-50 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-200 dark:hover:bg-slate-700"
        >
        ...
        <a
          ...
          class="group inline-flex items-center gap-2 rounded-lg border border-gray-200 bg-white px-4 py-2.5 text-sm font-medium text-gray-700 transition hover:bg-gray-50 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-200 dark:hover:bg-slate-700"
        >
          <svg class="h-4 w-4 text-gray-700 dark:text-slate-300" fill="currentColor" viewBox="0 0 24 24">
