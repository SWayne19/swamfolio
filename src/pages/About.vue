  ...
  <section id="about" class="mt-10 sm:mt-14" data-aos="fade-up">
    <div class="glass-card p-5 sm:p-7 md:p-8">
      ...
      <div class="mt-6 space-y-4 text-pretty text-sm leading-relaxed text-gray-500 sm:text-[15px] dark:text-slate-400">
        <p>
          I build end-to-end applications with
          <span class="font-semibold text-primary-600 dark:text-primary-400">Vue</span> frontends and
          <span class="font-semibold text-primary-600 dark:text-primary-400">Laravel + PostgreSQL</span> backends,
          keeping every layer fast, secure, and maintainable.
        </p>
        <p>
          I also integrate AI-assisted workflows into development -- writing smarter code, shipping faster, and learning continuously.
        </p>
      </div>
...
const chips = ["Vue 3", "Laravel", "Inertia.js", "PostgreSQL", "Tailwind CSS", "AI-assisted dev"];
