<template>
  <section v-if="project" class="space-y-3 sm:space-y-4">
    ...
    <div class="rounded-lg border border-gray-200 bg-white shadow p-4 sm:p-5 dark:border-slate-800 dark:bg-slate-900/60">
      ...
      <p class="mt-2 text-pretty text-sm leading-relaxed text-gray-600 dark:text-slate-300">{{ project.overview.goal }}</p>
    </div>
    ...
    <div class="rounded-lg border border-gray-200 bg-white shadow p-4 sm:p-5 dark:border-slate-800 dark:bg-slate-900/60">
      ...
      <p class="mt-2 text-pretty text-sm text-gray-600 dark:text-slate-300">{{ project.overview.challenges }}</p>
    </div>

    <div class="rounded-lg border border-gray-200 bg-white shadow p-4 sm:p-5 dark:border-slate-800 dark:bg-slate-900/60">
      <h3 class="text-sm font-semibold text-gray-900 dark:text-white">Outcome</h3>
      <p class="mt-2 text-pretty text-sm text-gray-600 dark:text-slate-300">{{ project.overview.outcome }}</p>
    </div>
  </section>
